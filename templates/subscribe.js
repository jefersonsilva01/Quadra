...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <link href="https://fonts.googleapis.com/css2?family=Anek+Odia:wght@100..800&family=Odibee+Sans&display=swap" rel="stylesheet">
    <title>
      Quadra
    </title>
    <!--[if !mso]><!-->
  ...
  <body style="word-spacing:normal;background-color:#F4F4F4;">
      ...
      <div
         style="font-family:Odibee Sans, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#55575d;"
      ><p style="line-height: 60px; text-align: center; margin: 10px 0;font-size:55px;color:#fcfcfc;font-family:'Odibee Sans',Helvetica,Arial,sans-serif"><b>QUADRA</b></p></div>
      ...
      ><p style="line-height: 30px; text-align: center; margin: 10px 0;color:#f5f5f5;font-size:25px;font-family:'Anek Odia',Helvetica,Arial,sans-serif"><span style="color:#ffffff;font-size:18px;font-family:'Anek Odia',Helvetica,Arial,sans-serif">Thanks for subscribe in our newsletter, <br>Check you inbox to get updated 
      <br>
      <a style="color:#ffffff;font-size:18px;font-family:'Anek Odia',Helvetica,Arial,sans-serif" href="${message}">Click here to order now</a>
      </span></p></div>
